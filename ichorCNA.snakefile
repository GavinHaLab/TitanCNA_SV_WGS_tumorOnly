...
rule correctDepth:
	input:
		...
		expand("results/ichorCNA/{tumor}/{tumor}.seg.txt", tumor=config["samples"]),
		expand("results/ichorCNA/{tumor}/{tumor}.params.txt", tumor=config["samples"]),
		expand("results/ichorCNA/{tumor}/{tumor}.correctedDepth.txt", tumor=config["samples"]),
